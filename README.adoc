...
== STATUS
image:https://github.com/ivanas93/prometheus-source-flink/actions/workflows/maven.yml/badge.svg[link="https://github.com/ivanas93/prometheus-source-flink/actions/workflows/maven.yml"] image:../badges/jacoco.svg[link="https://github.com/ivanas93/prometheus-source-flink/actions/workflows/coverage.yml"]
